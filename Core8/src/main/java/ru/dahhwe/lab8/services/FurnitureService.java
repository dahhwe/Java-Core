...
import ru.dahhwe.lab8.repositories.FurnitureRepository;
...
public class FurnitureService {
    ...
    public Furniture save(Furniture furniture) {
        ...
        jmsTemplate.convertAndSend("adminQueue", "Furniture with id " + savedFurniture.getId() + " has been added. Furniture details: " + savedFurniture);
    ...
    public void update(int id, Furniture furniture) {
        furniture.setId(id);
        Furniture updatedFurniture = repository.save(furniture);
        jmsTemplate.convertAndSend("adminQueue", "Furniture with id " + id + " has been updated. Furniture details: " + updatedFurniture);
    }
    ...
    public void delete(int id) {
        ...
        jmsTemplate.convertAndSend("adminQueue", "Furniture with id " + id + " has been deleted.");
    }
